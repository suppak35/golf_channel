CREATE OR REPLACE PACKAGE BODY SETTLEMN.SS_PKG_FILTER_PROCESS IS
...
P_USER_ID      SS_MASTER_CDR.USER_ID%TYPE;
  ...
  BEGIN
    ...
    V_SQL := 'SELECT TABLE_NAME,COLUMN_NAME,DATA_TYPE,DATA_LENGTH,NULLABLE FROM ALL_TAB_COLS WHERE TABLE_NAME =''' ||
             V_TABLE_NAME || '''';
